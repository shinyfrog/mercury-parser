...
var KnowablemagazineOrgExtractor = {
  domain: 'knowablemagazine.org',
  title: {
    selectors: [['meta[name="og:title"]', 'value']]
  },
  author: {
  ...
  content: {
    ...
    // The clean selectors will remove anything that matches from
    // the result
    clean: ['.promo-article-donate']
  }
};

var MediumComExtractor = {
  domain: 'medium.com',
  title: {
    selectors: [['meta[name="title"]', 'value']]
  },
...
var CustomExtractors = /*#__PURE__*/Object.freeze({
  ...
  KnowablemagazineOrgExtractor: KnowablemagazineOrgExtractor,
  MediumComExtractor: MediumComExtractor
});

...
describe('ArstechnicaComExtractor', () => {
  describe('initial test case', () => {
    ...
    it('returns the author', async () => {
      ...
      assert.equal(
        author,
        `Aaron Zimmerman, Nate Anderson, and Tom Mendelsohn`
      );
    });
    ...
    it('returns the date_published', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.equal(date_published, `2018-12-10T13:30:17.000Z`);
    });
    ...
    it('returns the dek', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.equal(dek, 'Need to buy a game? We have suggestions.');
    });
    ...
    it('returns the pages_rendered', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.equal(pages_rendered, undefined);
    });
    ...
    it('returns the content', async () => {
      ...
      assert.equal(
        first13,
        "If there's one thing board gamers love more than playing games, it's buying"
      );
    });
  });
});

...
describe('MediumComExtractor', () => {
  describe('initial test case', () => {
    ...
    beforeAll(() => {
      ...
      const html = fs.readFileSync('./fixtures/medium.com/1708529277462.html');
    ...
    it('returns the lead_image_url', async () => {
      ...
      assert.equal(
        lead_image_url,
        `https://miro.medium.com/v2/resize:fit:1080/1*HxEAnRcpkePVCcglWyKgoQ.png`
      );
    });
    ...
    it('returns the content', async () => {
      ...
      assert.equal(
        first13,
        'By the age of 46 years old, Elon Musk has innovated and built'
      );
    });
  });
});

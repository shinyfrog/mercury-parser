...
describe('KnowablemagazineOrgExtractor', () => {
  describe('initial test case', () => {
    ...
    beforeAll(() => {
      ...
      const html = fs.readFileSync(
        './fixtures/knowablemagazine.org/1708512889864.html'
      );
    ...
    it('returns the title', async () => {
      ...
      // in ./src/extractors/custom/knowablemagazine.org/index.js.
      const { title } = await result;

      // Update these values with the expected values from
      // the article.
      assert.equal(title, `A new look at our linguistic roots`);
    });

...
describe('SspaiComExtractor', () => {
  describe('initial test case', () => {
    let result;
    let url;
    beforeAll(() => {
      url = 'https://sspai.com/post/53005';
      const html = fs.readFileSync('./fixtures/sspai.com/1551795947839.html');
    ...
    it('returns the title', async () => {
      ...
      // in ./src/extractors/custom/sspai.com/index.js.
